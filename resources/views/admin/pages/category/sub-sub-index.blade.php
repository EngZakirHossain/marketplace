...
@section('page_title', 'Add Sub Sub Category')
@push('admin_style')
@endpush
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.category.store') }}" method="post">
                            ...
                            <div class="col-12 mb-3" data-select2-id="114">
                                <label for="select2Basic" class="form-label">Select Sub Category</label>
                            ...
                            <div class="col-12 mb-3">
                                <label class="input-label" for="exampleFormControlInput1">Sub Sub Category Name</label>
                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="card--header">
                            <h5 class="card-title">Sub Sub Category Table <span
                            ...
                            <form action="{{ url()->current() }}" method="GET">
                                <div class="input-group">
                                    <input id="datatableSearch_" type="search" name="search" class="form-control pl-5"
                                        placeholder="Search_by_Name" aria-label="Search" value="{{ $search }}"
